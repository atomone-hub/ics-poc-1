...
//
//	mockgen -package testutil -destination modules/provider/testutil/validator_mocks.go github.com/cosmos/cosmos-sdk/x/staking/types ValidatorI
//
...
func (m *MockValidatorI) GetConsAddr() ([]byte, error) {
	m.ctrl.T.Helper()
...
func (m *MockValidatorI) GetOperator() string {
	m.ctrl.T.Helper()
...
func (m *MockValidatorI) GetStatus() types0.BondStatus {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetStatus")
	ret0, _ := ret[0].(types0.BondStatus)
	return ret0
}
...
func (m *MockValidatorI) SharesFromTokens(amt math.Int) (math.LegacyDec, error) {
	m.ctrl.T.Helper()
...
func (mr *MockValidatorIMockRecorder) SharesFromTokens(amt any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockValidatorI) SharesFromTokensTruncated(amt math.Int) (math.LegacyDec, error) {
	m.ctrl.T.Helper()
...
func (mr *MockValidatorIMockRecorder) SharesFromTokensTruncated(amt any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
